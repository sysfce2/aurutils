...
__aur_list_fields() {
    ...
    if [[ ${#fields} -eq 0 ]]; then
        ...
        _values field $fields
    fi
}

# Helper to complete repoistory names
...
_aur_repo() {
    ...
    args=(
        + '(operations)'
        '(upgrade)'{-F,--field=}'[list the attribute FIELD]:field: __aur_list_fields'
        ...
        '(upgrade)--list-field[list valid fields in the local repository generated by repo-add]'
